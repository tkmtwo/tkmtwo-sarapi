 ...
 *
 */
public final class ValueToLocalDateConverter
  implements Converter<Value, LocalDate> {
  
  @Override
  public LocalDate convert(Value v) {
    ...
    DateInfo di = (DateInfo) o;
    return new LocalDate(di.GetDate());
  }
