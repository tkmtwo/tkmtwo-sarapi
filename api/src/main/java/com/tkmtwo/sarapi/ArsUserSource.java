...
/**
 * Bean-based implementation of an <code>ArsUserSource</code>.
 *
 * @author Tom Mahaffey
 */
public final class ArsUserSource
  implements FactoryBean, InitializingBean, DisposableBean {

  private static final Logger logger = LoggerFactory.getLogger(ArsUserSource.class);
